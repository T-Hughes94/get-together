...
class EventPage extends Component {
  ...
  render() {
    return (
      <div id="event-page" className="event-page">
        <h1 className="event-title">Event Details</h1>
        <div className="event-info">
          <label htmlFor="eventTitle" className="event-label">Event Title:</label>
          <input
            type="text"
            id="eventTitle"
            name="eventTitle"
        ...
        <div className="event-info">
          <label htmlFor="Invites" className="event-label">Guest Invites:</label>
          <input
            type="text"
            id="Invites"
            name="Invites"
        ...
        <button id="event-submit-button" className="event-submit-button" onClick={this.handleEventSubmit}>
          Submit Event
        </button>
      </div>
    );
